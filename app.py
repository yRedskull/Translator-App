...
class App(CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.combobox_listener = CTkComboBox(self.div_listener, width=300, cursor="hand2", state="readonly", justify="center", font=("Roboto", 20))
        self.combobox_listener.pack(pady=5)
        self.dropdown_listener = CTkScrollableDropdown(self.combobox_listener, values=list(LANGS_TRANSLATE.keys()), width=300, frame_corner_radius=0,
        ...
        self.combobox_translator = CTkComboBox(self.div_translator, width=300, cursor="hand2", state="readonly", justify="center", font=("Roboto", 20))
        self.combobox_translator.pack(pady=5)
        self.dropdown_translator = CTkScrollableDropdown(self.combobox_translator, values=list(LANGS_TRANSLATE.keys()), width=300,
                                                         frame_corner_radius=0, command=lambda get: change_language_translator(self, get))
